        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          <div className="flex items-center gap-2 bg-background border border-border rounded-lg px-3 py-2 shrink-0">
            ...
            <select 
              ...
              className="bg-transparent text-sm font-medium focus:outline-none border-none p-0 cursor-pointer min-w-[100px]"
            >
          ...
          <div className="text-xs font-medium text-muted ml-auto">

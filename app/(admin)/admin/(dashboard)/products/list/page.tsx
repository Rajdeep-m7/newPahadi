  ...
  return (
    <div className="p-8 space-y-8 max-w-[1600px] mx-auto animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <button 
          onClick={onAdd}
          className="flex items-center gap-2 px-6 py-3 bg-brand text-white rounded-xl text-sm font-bold hover:bg-brand-dark transition-all shadow-lg shadow-brand/20 active:scale-95 group"
        >
      ...
      {/* Top Actions Bar */}
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 bg-surface p-4 rounded-2xl border border-border shadow-sm">
        ...
        <div className="flex items-center gap-3 w-full xl:w-auto">
          <div className="relative">
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2.5 border border-border rounded-xl text-sm font-bold transition-all ${
            ...
            {showFilterModal && (
              <div ref={filterModalRef} className="absolute top-full right-0 mt-3 w-[340px] bg-surface border border-border rounded-2xl shadow-2xl z-50 p-6 animate-in fade-in zoom-in-95 duration-200">

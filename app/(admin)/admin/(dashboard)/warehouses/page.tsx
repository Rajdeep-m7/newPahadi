  ...
  return (
    <div className="p-8 space-y-8 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-white border border-border text-primary rounded-xl text-sm font-bold hover:bg-gray-50 transition-all shadow-sm active:scale-95 disabled:opacity-50"
          ...
          <button 
            onClick={handleAdd}
            className="flex items-center gap-2 px-5 py-2.5 bg-brand text-white rounded-xl text-sm font-bold hover:bg-brand-dark transition-all shadow-lg shadow-brand/20 active:scale-95"
          >
            <Plus size={18} />
            Add Warehouse
          </button>
      ...
      <div className="bg-surface rounded-xl border border-border shadow-sm overflow-hidden flex flex-col">
        {/* Search Bar */}
        <div className="p-4 border-b border-border bg-surface flex justify-between items-center gap-4">

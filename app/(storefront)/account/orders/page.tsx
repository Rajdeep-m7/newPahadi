                ...
                <div className="p-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-5">
                      <div className="w-20 h-20 rounded-lg bg-[#F5F5F5] p-2 flex-shrink-0">
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {order.items.slice(1).map((item, idx) => (
                          <div key={idx} className="flex items-center gap-3 p-3 rounded-xl border border-gray-50 bg-gray-50/30 hover:bg-gray-50 transition-colors">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <button 
                                onClick={() => handleWriteReview(item.snapshot.productId, item.snapshot.title, item.variantId)}

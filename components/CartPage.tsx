  ...
  return (
    <section className="w-full lg:h-[calc(100vh-120px)] lg:overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start flex-1 min-h-0 relative">
            ...
            {cartItems.map((item) => (
              ...
              >
                <div className="flex gap-4 sm:gap-6">
                  <div className="relative h-24 w-24 shrink-0 overflow-hidden rounded-2xl bg-gray-50 sm:h-32 sm:w-32 border border-gray-100">
                    <Image
        ...
        <div className="w-full lg:w-[400px] lg:sticky lg:top-0 shrink-0 pb-8 lg:pb-0">

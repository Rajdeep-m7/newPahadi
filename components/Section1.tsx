...
const Section1 = () => {
  return (
    <section className="w-full px-4 md:px-6 py-10">
      ...
      <div className="flex flex-wrap justify-around items-center px-5 gap-3 ">
        ...
        {categories.map((item, index) => (
          ...
          >
            ...
            <Image
              src={item.image}
              alt={item.name}
              className="h-28 w-28 md:h-32 md:w-32 object-cover transition-all duration-300 group-hover:scale-105"
            />

...
export const categorySales = [
  { name: "Electronics", sales: 45200, growth: 15.2 },
  { name: "Clothing", sales: 32800, growth: 8.7 },
    ...
    items: [
      {
        ...
        name: "Laptop Stand",
        image: "/placeholder.jpg",
        attributes: "Aluminum, Adjustable",
        quantity: 1,
        price: 1499,
      },
    ],
